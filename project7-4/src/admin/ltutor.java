...
/**
 * Servlet implementation class ltutor
 */
@WebServlet("/ltutor")
public class ltutor extends HttpServlet {
		...
		out.println("<html>\r\n" + 
				...
				"<article>\r\n" );
				 ...
				 try {
			            ...
			            ResultSet rs = stmt.executeQuery("select * from tutor1");
			            while (rs.next()) {
			                String n = rs.getString("uname");
			                String p=rs.getString("email");
			                out.println("<tr><td>" + n + "</td><td>" + p + "</td></tr>"); 
				 ...
				 out.println("</h2>");
				 out.println("<form action=\"tmodify\" >");
